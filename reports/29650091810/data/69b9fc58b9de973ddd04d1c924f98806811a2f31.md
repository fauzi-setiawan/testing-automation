...
- Name: practice-software-testing/auth.spec.js >> Authentication Module >> [TC-PST-AUTH-001] Login dengan kredensial valid
- Location: tests/practice-software-testing/auth.spec.js:19:5
